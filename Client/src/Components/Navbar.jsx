    ...
    <div className="flex items-center justify-between mx-3 h-16">
      <div className="flex items-center gap-10">
        <div className="flex items-center gap-2">
          <div title="Menu" className="rounded-full p-2 hover:bg-gray-200 cursor-pointer">
        ...
        <img
          ...
          alt="Gmail Logo"
        />
        <h1  className=" cursor-pointer text-2xl text-gray-500 font-medium">Gmail</h1>
      </div>
      ...
      {user && (
        <>
          ...
          <div className=" flex items-center gap-2">
            ...
            <Avatar className=" cursor-pointer" onClick={handleProfile} src={user.profilePhoto} size="40" round={true} />
          </div>
        </>
      )}
    </div>
